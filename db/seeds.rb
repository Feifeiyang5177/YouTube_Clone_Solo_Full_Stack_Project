...
user2 = User.create!(username: 'Andy_Ng', email: 'user2@gmail.com', password: '222222')
user3 = User.create!(username: 'Hien', email: 'user3@gmail.com', password: '333333')
user4 = User.create!(username: 'Emily_Wu', email: 'user4@gmail.com', password: '444444')
demo5 = User.create!(username: 'DemoUser', email: 'user5@gmail.com', password: '555555')

video1 = Video.create!(title: 'Introduction', creator_id: user2.id, description: "This is my first video!", view_count: 0)
intro1 = URI.open("https://yatube-seeds.s3.amazonaws.com/demo1.MOV")
video1.vd.attach(io: intro1, filename:"demo1.MOV")

video2 = Video.create!(title: 'Maleficent Trailer', creator_id: user3.id, description: "Short version of Maleficent movie trailer", view_count: 0)
demo5 = URI.open('https://yatube-seeds.s3.amazonaws.com/demo5.MOV')
video2.vd.attach(io: demo5, filename:'demo5.MOV')

video3 = Video.create!(title: 'Summer', creator_id: user4.id, description: "Erhu and piano playing Summer", view_count: 0)
...
As a frontend lead of Around the Block full-stack project, my job was to organize technical meetings with engineers to keep track of the working flow and process as well as collaborating with backend engineers to fetch the correct data and present on the frontend.", view_count: 0)
...
It also included Google Login-like user authentication.", view_count: 0)
...
video6 = Video.create!(title: 'Youtube Clone Show Page', creator_id: user2.id, description: "YaTube is a pixel perfect Youtube clone full stack project with Ruby on Rails on backend and React Redux on frontend. It incorporated Ruby, Rails, SQL, React, Redux, and JavaScript. 
It also included Google Login-like user authentication. This is the video show page on the app.", view_count: 0)
